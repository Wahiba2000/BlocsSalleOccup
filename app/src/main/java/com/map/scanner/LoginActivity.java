...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    static String userUrl = "https://glacial-caverns-30906.herokuapp.com/users/all";
    private ArrayList<com.map.scanner.beans.User> user;
        ...
        request = new StringRequest(Request.Method.GET, userUrl, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    Log.d("TAG", response);
                    Type type = new TypeToken<Collection<com.map.scanner.beans.User>>() {
                    }.getType();

                    Collection<com.map.scanner.beans.User> Users = new Gson().fromJson(response, type);
                    for(com.map.scanner.beans.User e : Users){
